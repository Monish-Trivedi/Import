<?php 
namespace Ktpl\Import\Model\Import; 
use Ktpl\Import\Model\Import\CustomImport\RowValidatorInterface as ValidatorInterface; 
...
{ 
    ...
    const TABLE_Entity = 'custom_table';
    /**
